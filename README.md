...
- A C++ compiler
- graphics.h (WinBGIm or equivalent)
- A compatible IDE such as Code::Blocks, Dev-C++, or Visual Studio
...
```bash
git clone https://github.com/your-username/OMBRE.git
```

Open the project in your preferred IDE and compile the source files.
